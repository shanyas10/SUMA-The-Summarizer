...
important sentences of the document. Whether or not shouuld a sentence be added to the summary is decided by a Naive Bayes classifier which acts
upon the document considering certain statistical and inguistic features like position, lengt, presence of keyword etc.
